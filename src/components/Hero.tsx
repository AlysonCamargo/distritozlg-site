      ...
      <section id="home" className="relative min-h-[90vh] flex flex-col justify-center overflow-hidden pt-20 pb-10">
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="max-w-3xl">
            <div className="inline-block px-3 py-1 mb-4 border border-accent/50 rounded-full bg-accent/10 backdrop-blur-sm animate-fadeIn">
              <span className="text-accent font-bold text-xs tracking-widest uppercase">🔥 Coleção Verão 2026</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-lg leading-relaxed animate-slideUp delay-100 font-light">
              Streetwear autêntico para <span className="text-accent font-medium">começar o ano</span> com estilo e atitude.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-slideUp delay-200">
              <a href="#catalog">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-accent text-accent-foreground font-bold px-8 py-6 text-lg hover:opacity-90 transition-all duration-300 gap-2 shadow-lg hover:shadow-glow border-0"
                >
              ...
              <a href="#about">
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full sm:w-auto border-2 border-accent text-accent hover:bg-accent/10 font-bold px-8 py-6 text-lg transition-all duration-300 gap-2"
                >
                  SAIBA MAIS
